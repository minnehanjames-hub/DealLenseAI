...
import { generateSectorReport, getMetadata } from "@/lib/api";
...
export default function ReportsPage() {
  ...
  async function handleGenerate() {
    ...
    setError(null);
    try {
      const blob = await generateSectorReport(sector, { sectors: [sector], limit: 1000 });
    ...
    <AppShell>
      <div className="mb-6">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-400">
          Export a sector overview with KPIs, top buyers, recent notable deals, AI commentary, watchpoints, and PE
          interest rationale.
        </p>
      </div>
